...
Create art from music!

---

## What it does

Synesthesia analyzes audio in real time and translates it into a generative painting on canvas.
...
- Download HTML file
- Upload the audio file or use the microphone
- Speak or just watch the painting form
- Then you can choose to download your art!
